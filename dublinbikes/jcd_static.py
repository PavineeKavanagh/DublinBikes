...
def main():
    ...
    add_station = ("UPDATE jcdecaux_static_dublin_bikes "
                   "(station_id,station_number,station_name,station_address,station_pos_lat,station_pos_lon,station_data_LUD) "
                   "VALUES (%s, %s, %s, %s, %s, %s, %s)")
    
    # print("Adding Values")

    # Generating the key for the database
    max_key = ("SELECT max(station_id) from jcdecaux_static_dublin_bikes")
    try:
    ...
    for station in stations:
        ...
        data_station = (key, station_number, station_name, station_address, station_pos_lat, station_pos_lon, station_data_LUD)
